...
const TSQueryCursorOptions *value_to_query_cursor_options(VALUE);
...
VALUE new_query_cursor_state(const TSQueryCursorState *);
VALUE new_query_cursor_state_by_val(TSQueryCursorState);
